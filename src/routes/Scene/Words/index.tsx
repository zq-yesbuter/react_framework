...
function Index(props: Props) {
  ...
  const { nameList, nameCur, namePageSize, nameRequest, batchDetail, nameTotal } = scene;
      ...
      <Card
        ...
        extra={
          <Button
            ...
            type="primary"
            onClick={() => {
              dispatch(routerRedux.push({ pathname: '/AI/scene/words/config' }));
            }}
          >
            新增话术
          </Button>
...
export default connect(
  ({
    scene,
    loading: {
      effects: { 'scene/fetchBatchDetail': loading },
    },
  }: {
    scene: any;
    loading: any;
