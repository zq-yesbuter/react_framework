...
const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('F:/homuanresource、/human_resources_platform/src/locales/en-US.js')),...((locale) => locale.__esModule ? locale.default : locale)(require('F:/homuanresource、/human_resources_platform/src/pages/user/login/locales/en-US.js')),
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('F:/homuanresource、/human_resources_platform/src/locales/pt-BR.js')),
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('F:/homuanresource、/human_resources_platform/src/locales/zh-CN.js')),...((locale) => locale.__esModule ? locale.default : locale)(require('F:/homuanresource、/human_resources_platform/src/pages/user/login/locales/zh-CN.js')),
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('F:/homuanresource、/human_resources_platform/src/locales/zh-TW.js')),...((locale) => locale.__esModule ? locale.default : locale)(require('F:/homuanresource、/human_resources_platform/src/pages/user/login/locales/zh-TW.js')),
    },
    locale: 'zh-TW',
